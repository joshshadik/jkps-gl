...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'jkps-sample.data';
    var REMOTE_PACKAGE_BASE = 'jkps-sample.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_jkps-sample.data');

    };
    Module['addRunDependency']('datafile_jkps-sample.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'jkps-sample.wast';
  var wasmBinaryFile = 'jkps-sample.wasm';
  var asmjsCodeFile = 'jkps-sample.temp.asm.js';
...
Module["asm"] = asm;
var __GLOBAL__sub_I_gltfModel_cpp = Module["__GLOBAL__sub_I_gltfModel_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_gltfModel_cpp"].apply(null, arguments) };
