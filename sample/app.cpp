...
void App::init()
{
	...
	_gUniforms._model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 0.0f)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.01f, 0.01f, 0.01f));
	_gUniforms._view = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -0.7f, -2.0f));
